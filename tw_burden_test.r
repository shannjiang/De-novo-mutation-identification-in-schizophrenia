...
origin_list = read.table(file="tw_permutation_DNM_lowDNMcountGene_removed.list",header = T,row.names=1,sep="\t")
...
write.csv(burden_test_permutation_result,file="tw_burden_test_10000permutation_result.csv")
